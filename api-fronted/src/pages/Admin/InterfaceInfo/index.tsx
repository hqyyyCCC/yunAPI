...
import {addRule, currentUser, removeRule, updateRule} from '@/services/ant-design-pro/api';
import {
...
const TableList: React.FC = () => {
  ...
  const handleOnline = async (selectedRows: API.IdRequest) => {
    ...
    try {
      ...
      hide();
      message.success('On-line successfully and will refresh soon');
      actionRef.current?.reload();
      return true;
    } catch (error) {
      hide();
      message.error('On-line failed, please try again');
      return false;
    }
  };
  /**
  ...
  const handleOffline = async (selectedRows: API.IdRequest) => {
    ...
    try {
      ...
      hide();
      message.success('Off-line successfully and will refresh soon');
      actionRef.current?.reload();
      return true;
    } catch (error) {
      hide();
      message.error('Off-line failed, please try again');
      return false;
    }
  };
  /**
