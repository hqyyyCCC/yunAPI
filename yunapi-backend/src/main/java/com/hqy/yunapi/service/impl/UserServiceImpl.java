...
import static com.hqy.yunapi.constant.UserConstant.ADMIN_ROLE;
import static com.hqy.yunapi.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public User userLogin(String userAccount, String userPassword, HttpServletRequest request) {
        ...
        String encryptPassword = DigestUtils.md5DigestAsHex((SALT + userPassword).getBytes());
        String pass = DigestUtils.md5DigestAsHex((SALT + "12345678").getBytes());
        System.out.println("加密后："+pass);
        //fe9b360d7080c7c11e2a7bfe190251c7
        //fe9b360d7080c7c11e2a7bfe190251c7
        // 查询用户是否存在
        QueryWrapper<User> queryWrapper = new QueryWrapper<>();
        queryWrapper.eq("userAccount", userAccount);
